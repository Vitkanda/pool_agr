...
//   const averageRating =
//     allPools.reduce(
//       (sum, pool) => sum + pool.properties.CompanyMetaData.rating,
//       0
//     ) / totalPools;
...
//       value: totalReviews,
//       icon: (
//         <RateReviewIcon fontSize="large" sx={{ color: "secondary.main" }} />
//       ),
//       color: "#fce4ec",
//     },
//     {
...
//         <meta
//           name="description"
//           content="Административная панель управления детскими бассейнами"
//         />
//       </Head>
...
//                       <Typography variant="body2" component="span">
//                         Отзывы:{" "}
//                         {pool.properties.CompanyMetaData.reviews?.length || 0}
//                       </Typography>
//                     </Box>
//                   </Box>
//                   <Box>
...
import Head from "next/head";
import AdminLayout from "@/slices/auth/AdminLayout";
import PoolsList from "@/slices/pool-details/poolList";


const PoolsAdminPage: React.FC = () => {
  return (
    <>
      <Head>
        <title>Управление бассейнами | Админ-панель</title>
        <meta
          name="description"
          content="Управление бассейнами в системе"
        />
      </Head>

      <AdminLayout title="Управление бассейнами">
        <PoolsList />
      </AdminLayout>
    </>
  );
